...
export default function Jumbotron() {
  return (
    <VuiBox py={3}>
      <VuiTypography textAlign="start" variant="h2" fontWeight="bold" color="black" mb="15px">
        Explore, collect, and sell NFTs
      </VuiTypography>
      <VuiTypography textAlign="start" variant="h5" fontWeight="light" color="black" mb="20px">
